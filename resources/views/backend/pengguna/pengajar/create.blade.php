                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="mengajar" class="form-control @error('mengajar') is-invalid @enderror">
                                            ...
                                            <option value="Matematika">Menghitung</option>
                                            <option value="Matematika">Membaca</option>
                                            <option value="Matematika">Menulis</option>
                                            <option value="Matematika">Menggambar</option>
                                            <option value="Matematika">Mengaji</option>
                                        </select>
                                        @error('mengajar')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
